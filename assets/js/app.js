...
(function ($) {
  ...
  window.Gp = {
    init: function () {
      ...
      this.headerFixed = {
        initialOffset:
          parseInt(this.header.attr("data-fixed-initial-offset")) || 100,
      ...
      this.mobileMenu = $("[data-mobile-menu-resolution]").data(
  ...
  GPTHEME.initialize = {
    ...
    general: function () {
      ...
      if ($(".CodeCursor__blog-filter").length > 0) {
        $(".CodeCursor__blog-filter").append('<li class="indicator"></li>');
        if ($(".CodeCursor__blog-filter li a").hasClass("isActive")) {
          var cLeft =
              $(".CodeCursor__blog-filter li a.isActive").position().left +
              "px",
            cWidth = $(".CodeCursor__blog-filter li a.isActive").css("width");
          $(".indicator").css({
            left: cLeft,
            width: cWidth,
          });
        }
        $(".CodeCursor__blog-filter li a").on("click", function () {
          $(".CodeCursor__blog-filter li a").removeClass("isActive");
      ...
      /*  Active Menu */
      $(".CodeCursor-main-menu li > a").each(function () {
      ...
      $(window).scroll(function (event) {
        ...
        $(".call-to-action-creative").each(function () {
          ...
          var inView =
            elPosRelToWindow > 0 && elPosRelToWindow < $(window).height() - 250;

          $("#debug").html(
            "elPosRelToWindow = " + elPosRelToWindow + "<br>inView = " + inView
          );
    ...
    handleFixedHeader: function () {
      ...
      if ($(document).scrollTop() > fixed.initialOffset) {
        if (
          (!Gp.isMobileMenu && fixed.enabled && !fixed.value) ||
    ...
    swiperSlider: function () {
      $(".swiper-container").each(function () {
        ...
        var swiper = new Swiper("#" + id, {
          ...
          slideVisibleClass: "CodeCursor-active-slide",
      ...
      if (exportFeatures) {
        var sliderFeature = $(".swiper-wrapper", exportFeatures),
        ...
        swiperExport.on("slideChange", function () {
          ...
          document.getElementById("slider-tab").classList =
            "dashboard-preview active-tab-" + e;
        });
      }
    ...
    portfolio: function () {
      if (
        ...
        $(".CodeCursor__portfolio-items").imagesLoaded(function () {
          var container = $(".CodeCursor__portfolio-items");

          container.isotope({
            itemSelector: ".CodeCursor__portfolio",
          ...
          $(".CodeCursor__isotope-filter a").on("click", function () {
            $(".CodeCursor__isotope-filter")
              .find(".current")
              .removeClass("current");
        ...
        var container = $(".CodeCursor__blog-items");
        $(".CodeCursor__blog-items").imagesLoaded(function () {
          container.isotope({
            itemSelector: ".CodeCursor__blog-grid",
            percentPosition: true,
            transitionDuration: "0.5s",
            masonry: {
              layoutMode: "masonry",
          ...
          $(".CodeCursor__blog-filter a").on("click", function () {
            $(".CodeCursor__blog-filter")
              .find(".current")
              .removeClass("current");
            $(this).parent().addClass("current");
    ...
    sectionSwitch: function () {
      $('[data-type="section-switch"], .gp-btn, .CodeCursor-main-menu li a').on(
        "click",
        function () {
          if (
    ...
    countDown: function () {
      $(".countdown").each(function (index, value) {
        ...
        $(this).countdown(count_date, function (event) {
          $(this).html(
            event.strftime(
              '<span class="CountdownContent">%D<span class="CountdownLabel">Days</span></span><span class="CountdownSeparator"></span><span class="CountdownContent">%H <span class="CountdownLabel">HR</span></span><span class="CountdownSeparator"></span><span class="CountdownContent">%M <span class="CountdownLabel">MIN</span></span><span class="CountdownSeparator"></span><span class="CountdownContent">%S <span class="CountdownLabel">SC</span></span>'
            )
          );
        });
      });
    ...
    tab: function () {
      ...
      $(".gp-tab ul.gp-tabs-nav li a").click(function (g) {
        ...
        tab
          .find(".tab_content")
          .find("div.gp_tabs_item")
          .not("div.gp_tabs_item:eq(" + index + ")")
          .slideUp();
        tab
          .find(".tab_content")
          .find("div.gp_tabs_item:eq(" + index + ")")
          .slideDown();
